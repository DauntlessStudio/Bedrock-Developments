...
createNew.command('entity')
  ...
  .addOption(new Option('-t, --type <type>', 'set entity type: dummy, passive, hostile, projectile',).choices(Object.keys(Entity.entityType)).default(Entity.entityType.dummy))

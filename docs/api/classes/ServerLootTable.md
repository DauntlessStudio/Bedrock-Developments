[bedrock-development](../README.md) / [Exports](../modules.md) / ServerLootTable

# Class: ServerLootTable
...
- [constructor](ServerLootTable.md#constructor)

### Properties

- [filePath](ServerLootTable.md#filepath)
- [pools](ServerLootTable.md#pools)

### Accessors

- [DirectoryPath](ServerLootTable.md#directorypath)

### Methods

- [replacer](ServerLootTable.md#replacer)
- [serialize](ServerLootTable.md#serialize)
- [toFile](ServerLootTable.md#tofile)
- [createFilePath](ServerLootTable.md#createfilepath)
- [createFromTemplate](ServerLootTable.md#createfromtemplate)
- [deserialize](ServerLootTable.md#deserialize)
- [fromFile](ServerLootTable.md#fromfile)
- [fromPathOrTemplate](ServerLootTable.md#frompathortemplate)

## Constructors

### constructor

• **new ServerLootTable**(`filepath`, `template`): [`ServerLootTable`](ServerLootTable.md)
...
| :------ | :------ |
| `filepath` | `string` |
| `template` | [`IServerLootTable`](../interfaces/IServerLootTable.md) |
...
• **pools**: [`IServerLootTablePool`](../interfaces/IServerLootTablePool.md)[]

#### Implementation of

[IServerLootTable](../interfaces/IServerLootTable.md).[pools](../interfaces/IServerLootTable.md#pools)
...
▸ **createFromTemplate**(`nameData`): [`ServerLootTable`](ServerLootTable.md)

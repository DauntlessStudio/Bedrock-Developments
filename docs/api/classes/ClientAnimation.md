[bedrock-development](../README.md) / [Exports](../modules.md) / ClientAnimation
...
- [constructor](ClientAnimation.md#constructor)

### Properties

- [animations](ClientAnimation.md#animations)
- [filePath](ClientAnimation.md#filepath)
- [format\_version](ClientAnimation.md#format_version)

### Accessors

- [DirectoryPath](ClientAnimation.md#directorypath)

### Methods

- [replacer](ClientAnimation.md#replacer)
- [serialize](ClientAnimation.md#serialize)
- [toFile](ClientAnimation.md#tofile)
- [createFilePath](ClientAnimation.md#createfilepath)
- [createFromTemplate](ClientAnimation.md#createfromtemplate)
- [deserialize](ClientAnimation.md#deserialize)
- [fromFile](ClientAnimation.md#fromfile)
- [fromPathOrTemplate](ClientAnimation.md#frompathortemplate)

## Constructors

### constructor

• **new ClientAnimation**(`filepath`, `template`): [`ClientAnimation`](ClientAnimation.md)
...
| :------ | :------ |
| `filepath` | `string` |
| `template` | [`IClientAnimation`](../interfaces/IClientAnimation.md) |
...
[ts/app/types/client/animation.ts:63](https://github.com/DauntlessStudio/Bedrock-Developments/blob/c7d1542/ts/app/types/client/animation.ts#L63)
...
▪ [key: [`ClientAnimationName`](../modules.md#clientanimationname)]: [`IClientAnimationAnim`](../interfaces/IClientAnimationAnim.md)

#### Implementation of

[IClientAnimation](../interfaces/IClientAnimation.md).[animations](../interfaces/IClientAnimation.md#animations)

#### Defined in

[ts/app/types/client/animation.ts:55](https://github.com/DauntlessStudio/Bedrock-Developments/blob/c7d1542/ts/app/types/client/animation.ts#L55)
...
[IClientAnimation](../interfaces/IClientAnimation.md).[format_version](../interfaces/IClientAnimation.md#format_version)

#### Defined in

[ts/app/types/client/animation.ts:54](https://github.com/DauntlessStudio/Bedrock-Developments/blob/c7d1542/ts/app/types/client/animation.ts#L54)
...
[ts/app/types/client/animation.ts:59](https://github.com/DauntlessStudio/Bedrock-Developments/blob/c7d1542/ts/app/types/client/animation.ts#L59)
...
[ts/app/types/client/animation.ts:69](https://github.com/DauntlessStudio/Bedrock-Developments/blob/c7d1542/ts/app/types/client/animation.ts#L69)

___

### createFromTemplate

▸ **createFromTemplate**(`nameData`): [`ClientAnimation`](ClientAnimation.md)
...
[ts/app/types/client/animation.ts:73](https://github.com/DauntlessStudio/Bedrock-Developments/blob/c7d1542/ts/app/types/client/animation.ts#L73)
